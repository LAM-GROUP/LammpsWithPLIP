...
PairStyle(Lars_NB_3,PairLars_NB_3)

#else

#ifndef LMP_PAIR_Lars_NB_3_H
#define LMP_PAIR_Lars_NB_3_H
...
class PairLars_NB_3 : virtual public PairEAM {
 public:
  PairLars_NB_3(class LAMMPS *);
  virtual ~PairLars_NB_3() {}
  void coeff(int, char **);
