...
PairStyle(Lars_NB_2,PairLars_NB_2)

#else

#ifndef LMP_PAIR_Lars_NB_2_H
#define LMP_PAIR_Lars_NB_2_H
...
class PairLars_NB_2 : virtual public PairEAM {
 public:
  PairLars_NB_2(class LAMMPS *);
  virtual ~PairLars_NB_2() {}
  void coeff(int, char **);
