...
PairLars_NB_05::PairLars_NB_05(LAMMPS *lmp) : PairEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairLars_NB_05::coeff(int narg, char **arg)
{
  int i,j;
...
void PairLars_NB_05::read_file(char *filename)
{
  Fs *file = fs;
...
void PairLars_NB_05::file2array()
{
  int i,j,m,n;
