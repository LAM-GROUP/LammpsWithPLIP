...
PairLars_NB_2::PairLars_NB_2(LAMMPS *lmp) : PairEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairLars_NB_2::coeff(int narg, char **arg)
{
  int i,j;
...
void PairLars_NB_2::read_file(char *filename)
{
  Fs *file = fs;
