...
PairStyle(Lars_NB_1,PairLars_NB_1)

#else

#ifndef LMP_PAIR_Lars_NB_1_H
#define LMP_PAIR_Lars_NB_1_H
...
class PairLars_NB_1 : virtual public PairEAM {
 public:
  PairLars_NB_1(class LAMMPS *);
  virtual ~PairLars_NB_1() {}
  void coeff(int, char **);
