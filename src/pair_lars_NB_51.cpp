...
PairLars_NB_51::PairLars_NB_51(LAMMPS *lmp) : PairEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairLars_NB_51::coeff(int narg, char **arg)
{
  int i,j;
...
void PairLars_NB_51::read_file(char *filename)
{
  Fs *file = fs;
...
void PairLars_NB_51::file2array()
{
  int i,j,m,n;
