...
PairStyle(Lars_NB_4,PairLars_NB_4)

#else

#ifndef LMP_PAIR_Lars_NB_4_H
#define LMP_PAIR_Lars_NB_4_H
...
class PairLars_NB_4 : virtual public PairEAM {
 public:
  PairLars_NB_4(class LAMMPS *);
  virtual ~PairLars_NB_4() {}
  void coeff(int, char **);
